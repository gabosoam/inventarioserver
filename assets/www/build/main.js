...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_api__ = __webpack_require__(94);
...
var Items = (function () {
    ...
    Items.prototype.borrarProductoDetalle = function (detalle) {
        var seq = this.api.delete('detalle/' + detalle).share();
    ...
    Items.prototype.buscarProductoNombre = function (nombre) {
    ...
    Items.prototype.buscarProductoCodigo = function (codigo) {
        var seq = this.api.get('producto?where={"codigo":{"contains":"' + codigo + '"},"estado":{"contains":"1"}}').share();
        return seq;
    };
    ...
    Items.prototype.obtenerGranel = function () {
        var seq = this.api.get('marca?sort=nombre&limit=300').share();
        seq.subscribe(function (res) {
            // If the API returned a successful response, mark the user as logged in
            if (res.status == 'success') {
    ...
    Items.prototype.obtenerProducto = function (codigo) {
        var seq = this.api.get('producto?codigo=' + codigo.name).share();
        seq.subscribe(function (res) {
            // If the API returned a successful response, mark the user as logged in
            if (res.status == 'success') {
                console.log(res);
    ...
    Items.prototype.obtenerDetalles = function (factura) {
        var seq = this.api.get('detalle/obtenerdetalle?factura=' + factura).share();
        seq.subscribe(function (res) {
            console.log('yes yes');
            console.log(res);
            // If the API returned a successful response, mark the user as logged in
    ...
    Items.prototype.crearFactura = function () {
        var _this = this;
        var seq = this.api.post('factura', null).share();
        seq.subscribe(function (res) {
            _this.ingfactura(res);
            // If the API returned a successful response, mark the user as logged in
            if (res.status == 'success') {
            }
            else {
    ...
    Items.prototype.crearProducto = function (producto) {
        var seq = this.api.post('producto', producto).share();
        return seq;
    };
    Items.prototype.modificarProducto = function (id, body) {
        var seq = this.api.put('producto/' + id, body).share();
        return seq;
    };
    Items.prototype.modificarStock = function (id, stock) {
        var seq = this.api.get('producto/modificarstock?id=' + id + '&stock=' + stock).share();
        return seq;
    };
    Items.prototype.buscarProducto = function (codigo) {
        var seq = this.api.get('producto?codigo=' + codigo).share();
        return seq;
    };
    Items.prototype.modificarCliente = function (cliente, factura) {
        var _this = this;
        var seq = this.api.put('factura/' + factura, { cliente: cliente }).share();
        seq.subscribe(function (res) {
            _this.ingfactura(res);
            // If the API returned a successful response, mark the user as logged in
            if (res.status == 'success') {
    ...
    Items.prototype.modificarPrecio = function (precio) {
        var seq = this.api.put('precio/' + precio.id, precio).share();
        return seq;
    };
    Items.prototype.agregarPrecio = function (precio) {
        var seq = this.api.post('precio', precio).share();
        return seq;
    };
    Items.prototype.eliminarPrecio = function (precio) {
        var seq = this.api.delete('precio/' + precio).share();
        return seq;
    };
    Items.prototype.obtenerPrecios = function (producto) {
        var seq = this.api.get('precio?producto=' + producto).share();
        return seq;
    };
    Items.prototype.generarIngreso = function (factura, cantidad, producto, precio) {
        var _this = this;
        var seq = this.api.post('detalle/', { factura: factura, cantidad: cantidad, producto: producto, precio: precio }).share();
        seq.subscribe(function (res) {
            _this.ingfactura(res);
            // If the API returned a successful response, mark the user as logged in
            if (res.status == 'success') {
    ...
    Items.prototype.ingfactura = function (factura) {
...
/* unused harmony export SearchPage2 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_printer__ = __webpack_require__(225);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_api__ = __webpack_require__(94);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var User = (function () {
    ...
    User.prototype.signup = function (accountInfo) {
        var _this = this;
        var seq = this.api.post('usuario', accountInfo).share();
        seq.subscribe(function (res) {
            // If the API returned a successful response, mark the user as logged in
            if (res.status == 'success') {
                _this._loggedIn(res);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_api__ = __webpack_require__(94);
